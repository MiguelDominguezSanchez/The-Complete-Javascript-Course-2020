...
function calcaAgeRetirement(year) {
	const age = new Date().getFullYear() - year
	return [age, 65 - age]
}

const [age, retirement] = calcaAgeRetirement(1990)
console.log(age2)
...
// isFullAge5(1900, 1999, 1965)
// isFullAge5(1900, 1999, 1965, 2016, 1987)
...
3. The name of the park that has moer than 1000 trees
...
function reportParks(p) {
	...
	console.log(`Our ${p.length} parks have an average oof ${avgAge} years.`)
